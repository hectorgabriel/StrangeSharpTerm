#!/usr/bin/env python3
"""Vendors a few 3dicons illustrations for the empty states.
...
So they go only where there is room and nothing else to look at -- a pane, a
...
The PNGs are committed, so a build needs no network. Each is shown at 64 to 96
points, which 400 pixels covers at up to 4x.
"""
import sys
...
# 3dicons name -> the empty state it stands beside.
ICONS = {
